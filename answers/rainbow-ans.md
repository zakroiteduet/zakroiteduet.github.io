...
Подставляем показатели преломления для красного $n=1{,}331$ и синего $n=1{,}334$ цвета и получаем:

\begin{equation}
\text{красный:} \qquad \alpha^\* = 71{,}91^\circ \qquad \theta^* = 230{,}4^\circ 
\end{equation}

\begin{equation}
\text{синий:} \qquad \alpha^\* = 71{,}52^\circ \qquad \theta^* = 233{,}5^\circ 
\end{equation}
