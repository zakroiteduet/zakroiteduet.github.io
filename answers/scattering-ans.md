...
\begin{equation} P = \frac{(9\cdot10^9)^3\cdot(1{,}6\cdot10^{-19})^6}{(3\cdot10^8)^3\cdot(9\cdot10^{-31})^2\cdot(0{,}5\cdot10^{-10})^4} = \frac{k^3e^6}{c^3m^2r^4} \end{equation}
